...
class UploadsApi(object):
    ...
    def list_project_scratch_files_paginated(self, proj_key, **kwargs):  # noqa: E501
        """list_project_scratch_files_paginated  # noqa: E501

        Get paginated list of temporary files uploaded to a project  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_project_scratch_files_paginated(proj_key, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_project_scratch_files_paginated_with_http_info(proj_key, **kwargs)  # noqa: E501

    def list_project_scratch_files_paginated_with_http_info(self, proj_key, **kwargs):  # noqa: E501
        """list_project_scratch_files_paginated  # noqa: E501

        Get paginated list of temporary files uploaded to a project  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_project_scratch_files_paginated_with_http_info(proj_key, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_project_scratch_files_paginated" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'proj_key' is set
        if self.api_client.client_side_validation and ('proj_key' not in local_var_params or  # noqa: E501
                                                        local_var_params['proj_key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `proj_key` when calling `list_project_scratch_files_paginated`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/project/{proj_key}/scratch/files_paginated', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
