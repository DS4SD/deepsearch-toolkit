...
class GenAIHFInferenceApiConfig(BaseModel):
    """
    Config for HF Inference API
    """ # noqa: E501
    genai_hf_api_key: SecretStr = Field(alias="GENAI_HF_API_KEY")
    __properties: ClassVar[List[str]] = ["GENAI_HF_API_KEY"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "GENAI_HF_API_KEY": obj.get("GENAI_HF_API_KEY")
        })
        return _obj
