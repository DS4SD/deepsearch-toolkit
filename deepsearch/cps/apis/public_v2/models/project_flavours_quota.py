...
class ProjectFlavoursQuota(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "proj_key", "quotas"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "quotas": [FlavoursQuota.from_dict(_item) for _item in obj["quotas"]] if obj.get("quotas") is not None else None
        })
        return _obj
