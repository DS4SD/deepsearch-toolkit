...
class ApiServerFastapiServerPublicModelsDataIndicesUploadModelsHttpSource(BaseModel):
    """
    ApiServerFastapiServerPublicModelsDataIndicesUploadModelsHttpSource
    """ # noqa: E501
    download_url: StrictStr
    head_url: Optional[HeadUrl] = None
    headers: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["download_url", "head_url", "headers"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of head_url
        if self.head_url:
            _dict['head_url'] = self.head_url.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "head_url": HeadUrl.from_dict(obj["head_url"]) if obj.get("head_url") is not None else None,
