...
class ProjectFlavourTotalKgs(BaseModel):
    """
    ...
    total_kgs: StrictInt
    __properties: ClassVar[List[str]] = ["proj_key", "flavour_name", "total_kgs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "flavour_name": obj.get("flavour_name"),
            "total_kgs": obj.get("total_kgs")
        })
        return _obj
