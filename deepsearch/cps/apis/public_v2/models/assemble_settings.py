...
class AssembleSettings(BaseModel):
    """
    AssembleSettings
    """ # noqa: E501
    mode: AssembleMode
    include_incomplete_documents: StrictBool
    __properties: ClassVar[List[str]] = ["mode", "include_incomplete_documents"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mode": AssembleMode.from_dict(obj["mode"]) if obj.get("mode") is not None else None,
            "include_incomplete_documents": obj.get("include_incomplete_documents")
        })
        return _obj
