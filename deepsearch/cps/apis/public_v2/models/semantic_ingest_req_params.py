...
class SemanticIngestReqParams(BaseModel):
    """
    SemanticIngestReqParams
    """ # noqa: E501
    skip_ingested_docs: StrictBool
    __properties: ClassVar[List[str]] = ["skip_ingested_docs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "skip_ingested_docs": obj.get("skip_ingested_docs")
        })
        return _obj
