...
SIZE1_ANY_OF_SCHEMAS = ["int", "object"]
...
class Size1(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = Size1.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Size1 with anyOf schemas: int, object. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Size1 with anyOf schemas: int, object. Details: " + ", ".join(error_messages))
        else:
            return instance
