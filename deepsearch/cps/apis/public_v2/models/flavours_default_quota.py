...
class FlavoursDefaultQuota(BaseModel):
    """
    FlavoursDefaultQuota
    """ # noqa: E501
    display_name: StrictStr
    name: StrictStr
    default_quota: StrictInt
    __properties: ClassVar[List[str]] = ["display_name", "name", "default_quota"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "default_quota": obj.get("default_quota")
        })
        return _obj
