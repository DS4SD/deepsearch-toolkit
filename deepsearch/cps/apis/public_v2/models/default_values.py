...
class DefaultValues(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ccs_project
        if self.ccs_project:
            _dict['ccs_project'] = self.ccs_project.to_dict()
        # override the default output from pydantic by calling `to_dict()` of dataflow
        if self.dataflow:
            _dict['dataflow'] = self.dataflow.to_dict()
        return _dict
