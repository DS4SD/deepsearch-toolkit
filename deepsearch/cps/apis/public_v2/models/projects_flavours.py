...
class ProjectsFlavours(BaseModel):
    """
    ProjectsFlavours
    """ # noqa: E501
    proj_key: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["proj_key", "name", "flavours"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "flavours": [Flavour.from_dict(_item) for _item in obj["flavours"]] if obj.get("flavours") is not None else None
        })
        return _obj
