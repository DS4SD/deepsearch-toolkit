...
class ProjectScratchFilesPaginated(BaseModel):
    """
    ProjectScratchFilesPaginated
    """ # noqa: E501
    files: List[ProjectScratchFiles]
    count: StrictInt
    page: StrictInt
    items_per_page: StrictInt
    __properties: ClassVar[List[str]] = ["files", "count", "page", "items_per_page"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "files": [ProjectScratchFiles.from_dict(_item) for _item in obj["files"]] if obj.get("files") is not None else None,
            "count": obj.get("count"),
            "page": obj.get("page"),
