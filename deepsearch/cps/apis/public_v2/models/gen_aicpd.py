...
class GenAICPD(BaseModel):
    """
    GenAI integration for watsonx settings
    """ # noqa: E501
    kind: Optional[StrictStr] = 'cpd'
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "kind": obj.get("kind") if obj.get("kind") is not None else 'cpd',
            "config": GenAICPDConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
