...
class DocumentMeta(BaseModel):
    ...
    description: Optional[DocumentMetaDescription] = None
    identifiers: Optional[Identifiers] = None
    __properties: ClassVar[List[str]] = ["filename", "description", "identifiers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "description": DocumentMetaDescription.from_dict(obj["description"]) if obj.get("description") is not None else None,
            "identifiers": Identifiers.from_dict(obj["identifiers"]) if obj.get("identifiers") is not None else None
        })
        return _obj
