...
class GenAIHFInferenceApi(BaseModel):
    """
    GenAI integration for Inference API settings
    """ # noqa: E501
    kind: Optional[StrictStr] = 'hf_api'
    ...
    def kind_validate_enum(cls, value):
        ...
        if value not in set(['hf_api']):
            raise ValueError("must be one of enum values ('hf_api')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "kind": obj.get("kind") if obj.get("kind") is not None else 'hf_api',
            "config": GenAIHFInferenceApiConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
