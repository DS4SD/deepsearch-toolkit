...
class SemanticIngestSourcePublicDataDocument(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "elastic_id", "index_key", "document_hash"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['public_data_document']):
            raise ValueError("must be one of enum values ('public_data_document')")
        return value
