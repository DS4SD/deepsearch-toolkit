...
class SemanticApi:
    ...
    def ingest(
        ...
        :type proj_key: str
        :param semantic_ingest_request: (required)
        :type semantic_ingest_request: SemanticIngestRequest
    ...
    def _ingest_serialize(
        ...
        if semantic_ingest_request is not None:
            _body_params = semantic_ingest_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/project/{proj_key}/semantic/ingest',
